...
int main()
{
    ...
    while(i < n) {
        cin >> key;
        if(SearchNodeBST(pNode, key)) cout << "A node with such data already exist. Please input the other value." << endl;
        else {
    ...
    while (choice >= '1' && choice <= '6'){
        ...
        case '2':
            ...
            cin >> key;
            cout << endl;
            if(!SearchNodeBST(pNode, key)) cout << "A node with such data does not exist." << endl;
            else {
